            ...
            <div className="container">
              <div className="panel panel-default">
                ...
                <card>
                  ...
                  <h6 className="panel-title">
                    {this.props.doc.accountDev != null ? ' Devise : ' + this.props.doc.accountDev : ''} </h6>

                  <h6 className="panel-title">
                    {this.props.doc.accountingDate != null ? ' Date comptable : ' + this.props.doc.accountingDate : ''} </h6>

                  <h6 className="panel-title">
                    {this.props.doc.editionDate != null ? ' Date  édition : ' + this.props.doc.editionDate : ''} </h6>


                  <h6 className="panel-title">
                    {age != null ? 'Agence édition :' + age : ''} </h6>

                  <h6 className="panel-title">
                    {this.props.doc.clientAgency != null ? ' Agence du client : ' + this.props.doc.clientAgency : ''} </h6>


                  <h6 className="panel-title">
                    {this.props.doc.addressMailClient != null && this.props.doc.addressMailClient !== "NOTFOUND" ? ' Email du client : ' + this.props.doc.addressMailClient : ''} </h6>


                  <h6 className="panel-title">
                    {this.props.doc.editionMode != null ? ' Mode édition : ' + this.props.doc.editionMode : ''} </h6>
