...
/*************************************** */
  ...
  state={
    ...
    handleClickOpen = (param) => {
     ...
     //console.log(param); 
     axios.get('http://135.125.203.95:1920/Rest/Api/Mails/listMails/'+param,{headers: headers})
         .then(res => {
    ...
    sendMail = (param,param1,param2,param3) => {
     ...
     axios.post('http://135.125.203.95:1920/Rest/Api/Mails/envoiMail/'+param, {
        subject: param1,
        messageBody: param2,
        listmail : param3,
      },{headers: headers})
	            ...
	            <td className="cell" >{event.typeDocument}</td>
                 <td  className="cell" >{event.accountBranch}</td>
                    ...
                    <Button  size="sm" className="mr-2"><i  className="fa fa-download"></i></Button>
                     <Button color="info" size="sm" className="mr-2"onClick={() => this.handleClickOpen(event.id)} ><i  className="fa fa-envelope"></i></Button>
          <Dialog
...
export default  class rechercheAvancee extends React.Component {
  ...
  componentWillMount() {
    ...
    axios.get('http://135.125.203.95:1920/Rest/Api/Bknom/getDevises', {headers: headers})         
       .then((response) => {
  ...
  getDocument(){
    ...
    axios.post('http://135.125.203.95:1920/Rest/Api/Documents/DocumentByKeyWords',{
