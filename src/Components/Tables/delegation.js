...
DeleteDelegation = (param) => {
    ...
    var  headers={
     ...
     'Authorization': "Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJiaDAwMzQ0NSIsImlhdCI6MTU1MzY3NzY3NiwiY29kZSI6ImJoMDAzNDQ1Iiwicm9sZXMiOlt7ImF1dGhvcml0eSI6IlJPTEVfVVNFUiJ9XX0.004WW131FR8Jy-aUtoppqL0Fr7UIwtHXjNT-Shx_PHg"
     ,     'Access-Control-Allow-Origin':'*'
 }
 
 console.log("l'id est "+param)
  axios.get('http://135.125.203.95:1920/Rest/Api/Delegations/DeleteDelegation/'+param,{headers: headers})
...
componentDidMount() {
        ...
        axios.get('http://135.125.203.95:1920/Rest/Api/Delegations/GetUserName/'+this.props.event.delegueId, {headers: headers})         
           .then((response) => {
...
export default  class FilterableEventTable extends React.Component {
  ...
  componentDidMount() {
        ...
        axios.get('http://135.125.203.95:1920/Rest/Api/Delegations/DelegationsOut', {headers: headers})         
           .then((response) => {
