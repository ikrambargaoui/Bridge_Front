...
console.log("l'id est "+param)
   ...
   // this.setState({ checked: [] });
    ...
    componentDidMount() {
        ...
        axios.get('http://135.125.203.95:1920/Rest/Api/Delegations/GetUserName/'+this.props.event.userId, {headers: headers})         
           .then((response) => {
...
export default  class FilterableEventTable extends React.Component {
  ...
  componentDidMount() {
        ...
        axios.get('http://135.125.203.95:1920/Rest/Api/Delegations/DelegationsIn', {headers: headers})         
           .then((response) => {
