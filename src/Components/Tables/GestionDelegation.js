...
,        'Access-Control-Allow-Origin':'*'
     ...
     axios.get('http://135.125.203.95:1920/Rest/Api/User/GetUserInformationByCuti/'+param,{headers: headers})
     .then(res => {
        this.setState({
      ...
      handleClose = () => {
       this.setState({ open: false });
        ...
        onChange(e){
         ...
         axios.post('http://135.125.203.95:1920/Rest/Api/Delegations/AddDelegation', {
          delegueCode: param1,
          dateDebDelegation: param2,
          dateFinDelegation : param3,
          },{headers: headers})
